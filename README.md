...
| [日常办公](1-工具箱/日常办公.md) | 终端增强、截图、翻译、浏览器插件等 |
| [效率工具](1-工具箱/效率工具.md) | 爬虫、抓取等                       |
...
| 文件                                   | 内容                                  |
| -------------------------------------- | ------------------------------------- |
| [AI平台与公司](3-发现/AI平台与公司.md) | 模型托管、算力服务、基础模型厂商      |
...
| [开发工具](3-发现/开发工具.md)         | API 测试、开发效率、IDE 插件          |
| [日常工具](3-发现/日常工具.md)         | 办公效率、知识管理、自建站点          |
| [前端技术](3-发现/前端技术.md)         | JS 库、运行时                         |
