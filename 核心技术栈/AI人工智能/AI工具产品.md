...
| mindsdb | MindsDB 是一个流行的开源 AI 分析查询引擎，它为需要直接从数据库、数据仓库和应用程序中回答问题的 AI 代理提供支持，无需 ETL 操作。                                                                         | [Link](https://github.com/mindsdb/mindsdb)     |
|         |                                                                                                                                                    |                                                |
...
| 名称                | 描述                                                   | 地址                                                       |
| ----------------- | ---------------------------------------------------- | -------------------------------------------------------- |
| ComfyUI           | ComfyUI 是一个开源的用户界面（UI）工具，旨在提供一种直观且灵活的方式来创建和定制图像生成流程。 | [Link](https://github.com/Comfy-Org/ComfyUI)             |
