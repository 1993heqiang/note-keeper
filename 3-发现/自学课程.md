...
| `architect-awesome`             | 后端架构师技术图谱                                                                                                         | [Link](https://github.com/xingshaocheng/architect-awesome)            |
| `advanced-java`                 | Java(Backend) Developers \| 互联网 Java 工程师进阶知识完全扫盲：涵盖高并发、分布式、高可用、微服务、海量数据处理等领域知识 | [Link](https://github.com/doocs/advanced-java)                        |
| `clean-code-javascript`         | Clean Code concepts adapted for JavaScript                                                                                 | [Link](https://github.com/ryanmcdermott/clean-code-javascript)        |
