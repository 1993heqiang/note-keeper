...
| mermaid       | 通过解析类 Markdown 的文本语法来实现图表的创建和动态修改。                                                                                        | [Link](https://github.com/mermaid-js/mermaid)          |
| brave         | **隐私浏览器**                                                                                                                 |                                                        |
|               |                                                                                                                           |                                                        |
...
| `hexhub`   | HexHub 为程序员和运维人员量身打造的一站式开发运维利器                                        | [Link](https://www.hexhub.cn/)               |
|            |                                                                       |                                              |
...
| PandaWiki | PandaWiki 是一款 AI 大模型驱动的开源知识库搭建系统                | [Link](https://github.com/chaitin/PandaWiki)   |
|           |                                                 |                                                |
...
| `PandaWiki` | PandaWiki 是一款 AI 大模型驱动的开源知识库搭建系统                                                                                                                      | [Link](https://github.com/chaitin/PandaWiki) |
| `docsify`   | A magical documentation site generator.                                                                                                               | [Link](https://github.com/docsifyjs/docsify) |
|             |                                                                                                                                                       |                                              |
...
| nocodb    | NocoDB 是构建**在线数据库**最快且最简单的方式。                   | [Link](https://github.com/nocodb/nocodb)          |
|           |                                                 |                                                   |
